...
<div class="dropdown inline">
    <button class="navbarThemesButton bg-green-2 hover:bg-green-500 py-3 rounded-full">
		...
		<li><router-link class="themes-drop bg-green-2 hover:bg-green-5 py-2 px-4 block whitespace-no-wrap content-link" @click="searchHunting" to="/hotels">Hunting trips</router-link></li>
		<li><router-link class="themes-drop bg-green-2 hover:bg-green-5 py-2 px-4 block whitespace-no-wrap content-link" @click="searchFitness" to="/hotels">Fitness trips</router-link></li>
		<li><router-link class="themes-drop bg-green-2 hover:bg-green-5 py-2 px-4 block whitespace-no-wrap content-link" @click="searchParty" to="/hotels">Party trips</router-link></li>
	</ul>
</div>
</template>
