<template>
    <nav>
        ...
        <Themes/>
        <router-link @load="GetUserDetails" v-if="this.$store.state.isLoggedIn" to="/MyPage" class="navbarMyProfileButton bg-green-2 hover:bg-green-500 py-3 rounded-full">MY PROFILE</router-link>
